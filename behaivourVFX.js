...
/*
!global.scBehaviorSystem Bloğu:
Bu blok, global.scBehaviorSystem adında bir nesnenin var olup olmadığını kontrol eder.
Eğer global.scBehaviorSystem nesnesi henüz tanımlanmamışsa, bu blok içine girer ve aşağıdaki işlemleri gerçekleştirir:
global.scBehaviorSystem adında boş bir nesne oluşturur.
globalTriggerSystem adında bir fonksiyon oluşturur. 
Bu fonksiyon, çeşitli olayları dinleyip tetikleyicilere yanıt verebilecek bir sistemdir.
addListener, removeListener, ve sendMessage fonksiyonları, 
globalTriggerSystem'in içindeki olay dinleme ve yanıt sistemini yönetir.
addCustomTriggerResponse, removeCustomTriggerResponse, ve sendCustomTrigger fonksiyonları, 
global.scBehaviorSystem nesnesine bu olay dinleme ve yanıt fonksiyonlarını ekler.
 Bu adımlar, global.scBehaviorSystem nesnesini bir davranış sistemine dönüştürür.
*/
...
!global.behaviorSystem Bloğu:
Bu blok, global.behaviorSystem adında bir nesnenin var olup olmadığını kontrol eder.
Eğer global.behaviorSystem nesnesi henüz tanımlanmamışsa, 
bu blok içine girer ve global.behaviorSystem'a global.scBehaviorSystem'ı atar. 
Bu adım, davranış sistemine global.behaviorSystem üzerinden erişimi sağlar.
